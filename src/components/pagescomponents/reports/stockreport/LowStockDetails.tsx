...
export function LowStockDetails({ onBack }: LowStockDetailsProps) {
  ...
  const handleExportExcel = () => {
    ...
    ws["!cols"] = [
      ...
      { wch: 16 }, // LOW THRESHOLD
      { wch: 20 }, // CURRENT QUANTITY
    ];

    ws["!rows"] = [{ hpt: 22 }, ...displayData.map(() => ({ hpt: 18 }))];

    const wb = XLSXStyle.utils.book_new();
    XLSXStyle.utils.book_append_sheet(wb, ws, "Low Stock Details");

    XLSXStyle.writeFile(wb, "Low_Stock_Details.xlsx");
  };
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="right">Low Threshold</th>
