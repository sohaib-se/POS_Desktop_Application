import type { SaleInvoiceViewRow, SaleInvoiceLineItem } from "./types";
...
export function createCsvContent(rows: SaleInvoiceViewRow[]) {
...
export const fallbackSaleInvoices: SaleInvoiceViewRow[] = [
  {
    id: "1",
    invoiceNo: "9",
    date: "21/02/2026",
