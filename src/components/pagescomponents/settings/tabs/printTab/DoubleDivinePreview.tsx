      ...
      <div style={{ padding: "0 20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
          <div>
            ...
            <div style={{ color: TEXT_MUTED, fontSize: 10 }}>GSTIN Number: 28VGVGV7878V1Z5</div>
            <div style={{ color: TEXT_MUTED, fontSize: 10 }}>State: 29-Karnataka</div>
          </div>
          <div>
            <div style={{ fontWeight: 700, color: redBg, marginBottom: 4, fontSize: 14 }}>Transportation Details:</div>
        ...
        <div style={{ display: "flex", gap: 20 }}>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 10, color: TEXT_MUTED, marginBottom: 12 }}>IBAN: AE12 3456 7890 1234 5678 901</div>

            <div style={{ fontWeight: 700, color: redBg, marginBottom: 4, fontSize: 14 }}>Invoice Amount In Words</div>
            <div style={{ fontSize: 10, color: TEXT_MUTED, marginBottom: 12 }}>One Lakh Two Thousand Four Hundred Fifty Two Rupees only</div>
