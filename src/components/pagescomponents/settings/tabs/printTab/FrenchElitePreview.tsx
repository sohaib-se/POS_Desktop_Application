    ...
    <div style={{ background: "#fff", padding: 20, fontFamily: "Inter, system-ui, sans-serif", border: "1px solid #000" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          ...
          {showCompanyName && ( <div style={{ fontSize: 16, fontWeight: 700, color: purpleBg, marginBottom: 6 }}>{showCompanyName ? companyName : ""}</div> )}
          {showPhone && ( <>
...
{logo ? <img src={logo} alt="Company Logo" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : null}
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
        <div style={{ width: "30%" }}>
          <div style={{ fontSize: 14, color: purpleBg, marginBottom: 8 }}><EditableText textKey="lbl_inv_no" defaultText="Invoice No.:" /> #1</div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9.5, marginBottom: 4 }}><span style={{ color: TEXT_MUTED }}>Invoice <EditableText textKey="lbl_date" defaultText="Date:" /></span><span>29/05/2020</span></div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9.5, marginBottom: 4 }}><span style={{ color: TEXT_MUTED }}>Invoice <EditableText textKey="lbl_time" defaultText="Time:" /></span><span>12:30 PM</span></div>
        ...
        <div style={{ width: "30%" }}>
          <div style={{ fontSize: 14, color: purpleBg, marginBottom: 8 }}><EditableText textKey="lbl_bill_to" defaultText="Bill To:" /></div>
        ...
        <div style={{ width: "30%" }}>
          ...
          <div style={{ display: "flex", gap: 10, fontSize: 9.5, marginBottom: 4 }}><span style={{ color: TEXT_MUTED, width: 80 }}>Delivery <EditableText textKey="lbl_date" defaultText="Date:" /></span><span>05 - Jun - 2020</span></div>
        </div>
      </div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", border: `1px solid ${BORDER}`, marginBottom: 20 }}>
        ...
        <tbody>
          ...
          <tr style={{ fontWeight: 700, background: purpleBg, color: "#fff" }}>
            <td style={{ padding: "6px 8px", borderRight: `1px solid #fff`, fontSize: 9.5 }} colSpan={3}><EditableText textKey="lbl_total" defaultText="Total" /></td>
      ...
      <div style={{ display: "flex", gap: 20 }}>
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 14, color: purpleBg, marginBottom: 8 }}><EditableText textKey="lbl_pay_to" defaultText="Pay To:" /></div>
          ...
          <div style={{ fontSize: 14, color: purpleBg, marginBottom: 8 }}><EditableText textKey="lbl_amount_words_no_colon" defaultText="Invoice Amount In Words" /></div>
          <div style={{ fontSize: 9.5, color: TEXT_MUTED, marginBottom: 12 }}>One Lakh Two Thousand Four Hundred Fifty Two Rupees only</div>

          <div style={{ fontSize: 14, color: purpleBg, marginBottom: 8 }}><EditableText textKey="lbl_terms_no_colon" defaultText="Terms And Conditions" /></div>
