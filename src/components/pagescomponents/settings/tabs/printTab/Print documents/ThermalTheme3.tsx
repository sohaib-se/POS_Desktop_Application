...
/* ─────────── ThermalSaleInvoiceImpact — clean monospace layout ─────── */

export function ThermalSaleInvoiceImpact({
    records,
    invoiceNo,
    invoiceDate,
    customerName,
    ...
    const rule = (char: string) => (
        <div style={{ borderTop: char === "=" ? "2px solid #111" : "1px dashed #555", margin: "4px 0" }} />
    );
    ...
    return (
        ...
        >
            ...
            <div style={{ ...row, fontSize: 15, fontWeight: 800, margin: "2px 0" }}>
                <span>TOTAL</span>
                <span>{fmt(total)}</span>
            </div>
