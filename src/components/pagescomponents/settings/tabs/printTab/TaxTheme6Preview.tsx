...
export function TaxTheme6Preview({ color }: { color?: string }) {
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 4, padding: 20, fontFamily: "Inter, system-ui, sans-serif", border: `1px solid ${BORDER}` }}>
      <div style={{ textAlign: "center", fontWeight: 700, fontSize: 16, marginBottom: 10 }}>Sale</div>
      ...
      <table style={{ width: "100%", fontSize: 9.5, borderCollapse: "collapse", border: `1px solid ${BORDER}`, borderTop: "none", marginBottom: 10 }}>
        <thead>
          <tr style={{ background: themeBg, borderBottom: `1px solid ${BORDER}` }}>
            {["#", "Item name", "HSC/SAC", "Quantity", "Price/unit", "Discount", "CGST", "SGST", "Amount"].map((h) => (
        ...
        <tbody>
          <tr>
            <td style={td}>1</td><td style={td}>ITEM 1</td><td style={td}>1234</td><td style={td}>1+1</td><td style={td}>10.00</td><td style={td}>0.10 (1%)</td><td style={td}>0.25 (2.5%)</td><td style={td}>0.25 (2.5%)</td><td style={{ ...td, borderRight: "none" }}>10.40</td>
          </tr>
          <tr>
            <td style={td}>2</td><td style={td}>ITEM 2</td><td style={td}>6325</td><td style={td}>1</td><td style={td}>30.00</td><td style={td}>0.00 (0%)</td><td style={td}>2.70 (9%)</td><td style={td}>2.70 (9%)</td><td style={{ ...td, borderRight: "none" }}>35.40</td>
          </tr>
          <tr style={{ fontWeight: 600 }}>
            <td style={td} colSpan={3}>Total</td><td style={td}>2 + 1</td><td style={td} /><td style={td}>0.10</td><td style={td}>2.95</td><td style={td}>2.95</td><td style={{ ...td, borderRight: "none" }}>45.80</td>
          </tr>
        </tbody>
      </table>
      
      <div style={{ display: "flex", fontSize: 9, border: `1px solid ${BORDER}`, borderTop: "none", marginBottom: 10 }}>
        <table style={{ flex: 1, borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: themeBg, color: "#fff" }}>
              <th style={{ padding: "4px", borderRight: `1px solid #fff`, textAlign: "left" }}>Tax details</th>
              <th style={{ padding: "4px", borderRight: `1px solid #fff`, textAlign: "left" }}>2.5%</th>
              <th style={{ padding: "4px", borderRight: `1px solid #fff`, textAlign: "left" }}>9%</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style={{ padding: "2px 4px", borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>CGST</td>
              <td style={{ padding: "2px 4px", borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>Rs 1.26</td>
              <td style={{ padding: "2px 4px", borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>Rs 2.70</td>
            </tr>
            <tr>
      ...
      <div style={{ display: "flex", fontSize: 9.5, border: `1px solid ${BORDER}`, borderTop: "none", marginBottom: 10 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ background: themeBg, color: "#fff", fontWeight: 600, padding: "4px 6px", textAlign: "center" }}>Description</div>
          <div style={{ color: TEXT_MUTED, padding: "8px", textAlign: "center" }}>Sale Description</div>
        </div>
      </div>
        ...
        <tbody>
          <tr>
            ...
            <td style={{ padding: "8px", verticalAlign: "top" }}>
              ...
              <div style={{ textAlign: "right" }}>
                <div style={{ fontWeight: 600, marginBottom: 6, textAlign: "right" }}>For: My Company</div>
