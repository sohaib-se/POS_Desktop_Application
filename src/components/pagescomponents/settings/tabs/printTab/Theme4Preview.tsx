...
export function Theme4Preview({ color }: { color?: string }) {
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 4, padding: 20, fontFamily: "Inter, system-ui, sans-serif", border: `1px solid ${BORDER}` }}>
      ...
      <div style={{ textAlign: "center", fontWeight: 700, fontSize: 16, color: themeBg, marginBottom: 10 }}>Sale</div>
      
      <table style={{ width: "100%", fontSize: 10, borderCollapse: "collapse", border: "none", marginBottom: 10 }}>
        <tbody>
          <tr style={{ fontWeight: 600 }}>
            <td style={{ padding: "4px 6px", width: "33%" }}>Bill To:</td>
      ...
      <div style={{ display: "flex", fontSize: 9.5, border: `1px solid ${BORDER}`, borderBottom: "none" }}>
      ...
      <div style={{ border: `1px solid ${BORDER}`, borderTop: "none", padding: "4px 6px" }}>
        ...
        <div style={{ color: TEXT_MUTED, fontSize: 9.5 }}>Forty Two Rupees and Thirty Two Paisa only</div>
      </div>

      <div style={{ border: `1px solid ${BORDER}`, borderTop: "none", padding: "4px 6px" }}>
        <div style={{ fontWeight: 600, color: themeBg }}>Description</div>
        <div style={{ color: TEXT_MUTED, fontSize: 9.5 }}>Sale Description</div>
      </div>
      
      <div style={{ border: `1px solid ${BORDER}`, borderTop: "none", padding: "4px 6px" }}>
        <div style={{ fontWeight: 600, color: themeBg }}>Terms and conditions</div>
        <div style={{ color: TEXT_MUTED, fontSize: 9.5 }}>Thanks for doing business with us!</div>
      </div>

      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9.5, border: `1px solid ${BORDER}`, borderTop: "none" }}>
