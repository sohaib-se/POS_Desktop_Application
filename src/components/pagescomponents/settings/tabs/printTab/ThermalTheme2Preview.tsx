...
export function ThermalTheme2Preview() {
  ...
  return (
    <div style={{ background: "#fff", border: `1px solid ${BORDER}`, boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)", padding: "16px", fontFamily: "Inter, system-ui, sans-serif", fontSize: 9.5, color: TEXT_DARK, maxWidth: 320, margin: "0 auto", lineHeight: 1.4 }}>
      ...
      <div style={{ color: TEXT_MUTED, paddingLeft: 15, fontSize: 8.5 }}>MRP: 100.00, Batch No.: N1234, Model No.: A12345, Exp. Date: 08/2027, Mfg. Date: 12/08/2026, Size: Med/32</div>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", marginTop: 4 }}>
        <div style={{ display: "flex", width: 160 }}><span style={{ flex: 1 }}>Sub Total :</span><span style={{ width: 60, textAlign: "right" }}>17,475.00</span></div>
      ...
      <div style={dash} />
      <div>Balance to be paid in 3 days</div>
    </div>
  );
}
