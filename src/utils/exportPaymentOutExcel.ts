// Utility: export Payment-Out transactions to a styled .xlsx file
...
export function exportPaymentOutToExcel(
  records: any[],
  ...
  const filename = `paymentout_transactions_${monthLabel}_${yearLabel}.xlsx`;
  ...
  const dataRows = records.map((r) => [
    ...
    { v: String(r.paymentNo || r.payment_no || r.receiptNo || r.receipt_no || ""), t: "s", s: dataStyleLeft  },
